...
\abstract{In Mehweb, periphrastic causatives are formed by a combination of the
infinitive of the lexical verb with another verb, originally a caused motion verb. 
Various tests that Mehweb periphrastic causatives do not qualify as fully grammaticalized. 
But the constructions are not compositional expressions, either. While a clause usually contains
either a morphological or a periphrastic causative marker, there are instances where,
in a periphrastic causative construction, the lexical verb
itself may carry the causative affix, resulting in only one causative
meaning.
