...
\abstract{This paper describes the semantic inventory and morphosyntactic
properties of specialized converbs in Mehweb. The data for the
description were collected during field trips to the village of Mehweb. Converbs with the following meanings are
described:~anteriority, immediacy, inceptivity, simultaneity,
posteriority, hypothetical conditionality, counterfactuality,
concessivity (and another meaning close to concessivity), causality,
purpose and graduality. A participle-based form with the semantics of a
locative converb is discussed.
