...
\abstract{This paper describes the sociolinguistic~situation of Mehweb, a lect of
the Dargwa branch of East Caucasian, spoken in the Republic of
Daghestan. In the course of several field trips to the village
of Mehweb (officially, Megeb), sociolinguistic interviews were conducted in Mehweb and four neighbouring Avar- and Lak-speaking villages. The paper describes the
demographic situation in Mehweb, the villagers' official status, their
social and economic life in the past and at present. The multilingual
repertoire of Mehwebs and their neighbours is described in both
qualitative and quantitative terms. I conclude that, while there are no
signs of language loss, the traditional patterns of multilingualism in
Mehweb are highly endangered.}
...
The Mehwebs write in \isi{Avar} or \isi{Russian}.
...
The command of \isi{Russian}, \isi{Avar}, and \isi{Lak} is spread in Mehweb (see \sectref{neighbours-and-language-contact}
...
old) – \isi{Avar} and \isi{Russian}, which, according to their parents, is not
...
Secondly, most Mehwebs are registered as Avars\is{Avar} in their passports. That
...
792 residents indicated Dargwa as their first language, while 53 indicated \isi{Avar}.
...
decreased as much as in many other neighbouring villages. For example, the \isi{Avar}
villages \isi{Obokh} and \isi{Shangoda} were twice as populated in the past. The \isi{Lak}
villages \isi{Mukar} and \isi{Uri} are on the verge of complete abandonment. However, several
families still live in the \isi{Lak} villages \isi{Palisma} and \isi{Kamakhal}, which were
recently among the biggest in the neighbourhood. The \isi{Avar} village of
...
neighbouring villages: Obokh and Shangoda (\isi{Avar}) and Uri and Mukar (\isi{Lak})
...
The closest neighbours of Mehweb are the \isi{Avar} villages \isi{Obokh} and
...
Mehwebs acquired \isi{Avar} through their communication with the neighbouring
...
Chokh, and Gunib. There were no \isi{Lak} villages located as close as Obokh
...
About 20\% of Mehwebs of this generation spoke \isi{Russian}. The command of
...
The residents of \isi{Lak} villages also had some command of \isi{Avar}, but the
...
Mehweb and Obokh spoke virtually no \isi{Lak} (\tabref{Table3}). In Shangoda, the
command of Lak persisted longer, but it was almost lost in the
generation born after 1960. The command of \isi{Avar} in Lak villages Uri and
...
Some Mehwebs reported a command of the Akusha dialect of \isi{Dargwa}. In the
