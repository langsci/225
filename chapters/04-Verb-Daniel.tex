...
\abstract{The paper describes the morphology of the verb in
Mehweb, a Dargwa lect of central Daghestan, Russia. The description is
partly based on previous research (\citealt{magometov1982}, \citeauthor{sumbatova:unpublished} unpublished) and partly on the field data the author has been collecting
from 2009 to the present. Mostly, formal morphology of synthetic verb
forms and complex verbs are discussed.
...
and in East Caucasian languages is so far only attested in \isi{Akhvakh}
\citep{creissels2008,creissels2018} and Zakatala \isi{Avar} \citep{forker2018}. Below, this
...
\emph{ask'-es} `catch on', \emph{꞊alk'ʷ-es} `burn', \emph{abx-es}
`open', \emph{꞊arx-es} `send', \emph{꞊arχ-es} `touch', \emph{꞊aˤlq'-es}
`rinse', \emph{꞊alħʷ-es} `wake up', \emph{꞊aˤld-es} `hide'. However,
some verbs, including \emph{꞊aˤlq-aˤs} `give harvest', \emph{꞊aˤbʡ-as}
`kill', \emph{꞊aˤrʡ-as} `freeze', \emph{꞊aˤrʜ-as} `copulate' do choose
...
monoconsonantal base expresses the meaning of ventive (\emph{k-} and
...
Lezgic languages, \isi{Archi} \citep[291]{kibrik1977} and \isi{Agul} \citep{maisak-merdanova2004},
and later also reported in \isi{Chirag} by Dmitry Ganenkov. In \citet{daniel-maisak2014,maisak2016},
